...
/**
 * Thrown when an index definition (taken as user input or read from the system catalog) is not valid.
 */
class InvalidIndexDefinitionException(message: String, cause: Throwable? = null) : RuntimeException(message, cause)